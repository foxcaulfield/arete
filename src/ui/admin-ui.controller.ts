...
export class AdminUiController {
	public constructor(private readonly adminUiService: AdminUiService) {}

	/* Admin routes */
	@Get()
	@Render("admin/dashboard.njk")
	public async adminDashboard(): Promise<object> {
		return this.adminUiService.getAdminDashboard();
	}
	...
	public adminUserCreate(): object {
		return this.adminUiService.getAdminUserCreate();
	}
	@Get("users/:id")
	@Render("admin/user-detail.njk")
	public async adminUserDetail(@Param("id") userId: string): Promise<object> {
		return this.adminUiService.getAdminUserDetail(userId);
	}
	@Get("users/:id/edit")
	@Render("admin/user-edit.njk")
	public async adminUserEdit(@Param("id") userId: string): Promise<object> {
